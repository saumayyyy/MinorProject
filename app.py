...
data_path = '/mnt/data/Zomato data .csv'  # Path to your dataset
...
# ---- Online vs Offline Orders Pie Chart (Replaced) ----
# This section is replaced by the heatmap above
...
# ---- Add Additional Graphs (Line Graph, Table, etc.) if needed ----
